...
const pageStyle = {
  ...
  const cursorStyles = {
    ...
    transition: 'transform 1s ease', // Animate the cursor movement
...
//        setIsClicking(false);
    ...
    switch (intervalPage) {
      ...
      default:
        ...
        console.log(activePage+ " "+intervalPage);
...
//    if (button1 && button2) {
      ...
      const button1Center = {
        x: button1Rect.left + button1Rect.width / 2,
        y: button1Rect.top + button1Rect.height / 2,
      };

      const button2Center = {
        x: button2Rect.left + button2Rect.width / 2,
        y: button2Rect.top + button2Rect.height / 2,
      };
...
<>
      <div id="virtual-cursor" style={{ ...cursorStyles }} />
<div style={pageStyle2}>  
{<Page24 />}
</div>
...
style={{
      ...
      />
              ...
              <Button id="button3" variant={isDanger4 ? "success" : "primary"} type="submit" className="mt-3">
                Enter
              </Button>
            </Form>
          )}
...
style={{
        border: hasError2 ? '3px solid green' : '1px solid #ced4da' // Conditionally apply red border
              ...
              <Button id="button5" variant={isDanger6 ? "success" : "primary"} type="submit" className="mt-3">
                Enter
              </Button>
            </Form>
          )}
...
<div style={{paddingTop: '10px', paddingBottom: '15px'}}>
        <Button id="button6" variant={isDanger7 ? "success" : "primary"} type="submit">
          Enter
        </Button>
</div>
      </Form>
