...
import howToUseImage from './how-to-use.gif';
...
const Section = ({ title, description, imageUrl, price, alt, visible }) => (
  <div
    style={{
      ...styles.section,
      backgroundColor: alt ? '#f9f9f9' : '#fff',
  ...
  >
    ...
    <p style={styles.sectionPrice}>{price}</p>
  </div>
);
    ...
    <div style={styles.app}>
      ...
      <div
        ...
        style={{
          ...
          ...(visibleSections.howToUse ? styles.visible : {}),
        }}
      >
        <h2>How to Use Expense Tracking</h2>
        <div style={styles.imageContainer}>
          <img
            src={images[currentImageIndex]}
            alt={`How to Use Step ${currentImageIndex + 1}`}
            style={styles.image}
          />
        </div>
      ...
      <div ref={freePlanRef}>
        <Section
          visible={visibleSections.freePlan}
          title="Free Plan"
      ...
      <div ref={premiumPlanRef}>
        <Section
          visible={visibleSections.premiumPlan}
          title="Premium Plan"
      ...
      <div ref={enterprisePlanRef}>
        <Section
          visible={visibleSections.enterprisePlan}
