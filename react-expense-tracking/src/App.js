...
const Page23 = () => {
  ...
  const [mainTableTop, setMainTableTop] = useState("6px");
  const [topLeftTableTop, setTopLeftTableTop] = useState("140px");
  const [topCenteredTableTop, setCenteredTableTop] = useState("470px");
  const [topCenteredTable2Top, setCenteredTable2Top] = useState("140px");
  const [topTableContainerTop, setTableContainerTop] = useState("240px");
  ...
  const updateZoomLevel = () => {
   const userAgent = navigator.userAgent || navigator.vendor || window.opera;
    ...
    if (/SamsungBrowser/i.test(userAgent)) {
      ...
      setWidthLevel6("12px");
      setTopLeftTableTop("545px");
      setMainTableTop("13px");
      setCenteredTableTop("1045px");
      setCenteredTable2Top("545px");
      setTableContainerTop("665px");
      setFontSize('24px');
      setTopValue1('-5%');
      setTopValue2('-20%');
      setTopValue3('-30%');
    ...
    if (/SamsungBrowser/i.test(userAgent)) {
      ...
      setWidthLevel6("14px");
      setTopLeftTableTop("280px");
      setCenteredTableTop("740px");
      setCenteredTable2Top("280px");
      setTableContainerTop("380px");
      setMainTableTop("7px");
      setFontSize('21px');
      setTopValue1('0%');
      setTopValue2('0%');
    ...
    if (/SamsungBrowser/i.test(userAgent)) {
      ...
      setWidthLevel6("16px");
      setTopLeftTableTop("140px");
      setCenteredTableTop("490px");
      setCenteredTable2Top("140px");
      setTableContainerTop("240px");
      setMainTableTop("6px");
      setFontSize('18px');
      setTopValue1('-10%');
      setTopValue2('-25%');
...
const Page22 = () => {
    return (
        <>
            <p style={{ fontSize: '20px' }}>&nbsp;</p>
            <p style={{ fontSize: mainTableTop }}>&nbsp;</p>
...
{(activePage === 'step0' || activePage === 'step1' || activePage === 'step2' || 
  ...
  activePage === 'step12') ? (
    ...
    loggedInUser ? (
      ...
      <p style={styles.bingH1} >Expense Tracking</p>
...
const headerStyle = {
  ...
  left: '0',
  width: '100%',
  padding: '60px', // Adjusted padding to fit content better
  zIndex: 3,
  backgroundColor: '#fff',
