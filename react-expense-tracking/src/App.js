...
const steps = [
  "Introduction to Expense Tracking\nIn this project, you'll follow 3 simple steps:\n1. Create Tasks\n2. Add Participants*\n3. Log Expenses\n*Remember to add yourself as a participant.\n\nClick Next to begin!",
  ...
  "Fill in Task Details\nOn this form, enter:\n- Task Name in the field labeled 'Enter task name'\n- Measuring Unit in 'Enter measuring unit'\n- Quantity in 'Enter quantity'\n\nClick Next to see an example.",
  ...
  "Fill in Participant Details\nOn this form, enter:\n- Participant Name in the 'Enter participant name' field\n- Participant Email in the 'Enter participant email' field\n\nClick Next for an example.",
  ...
  "Fill in Expense Details\nOn this form, enter:\n- Expense Description in the 'Enter expense description' field\n- Quantity in the 'Enter quantity' field\n\nClick Next to see an example.",
  ...
  "Review Your Web Page\nYour expense tracking web page is now ready and reflects the information you entered.\n\nThat's it – you're done!"
];
...
//          setSelectedParticipant('My Participant Name');
          setShowTaskParticipant(true);
          setShowModal(true);
          setShowTaskForm(false);
          setShowParticipantForm(true);
